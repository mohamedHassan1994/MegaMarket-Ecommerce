...
@section('title', 'Fashion Store - Home')
...
@section('content')
    ...
    <section id="billboard" class="bg-light py-5">
        <div class="container">
            ...
            <div class="row">
                <div class="collections-slider-container py-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="collections-slider">
                        <div class="collections-slides-wrapper" id="collectionsWrapper">
                            <!-- Slide 1 -->
                            <div class="collections-slide active">
                                <div class="collections-banner-item">
                                    <div class="collections-image-holder">
                                        <a href="#">
                                            <img src="images/banner-image-6.jpg" alt="product" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Soft leather jackets</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="collections-slide">
                                <div class="collections-banner-item">
                                    ...
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Premium Denim</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                            ...
                            <div class="collections-slide">
                                <div class="collections-banner-item">
                                    ...
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Winter Collection</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                            ...
                            <div class="collections-slide">
                                <div class="collections-banner-item">
                                    ...
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Out crop sweater</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                            ...
                            <div class="collections-slide">
                                <div class="collections-banner-item">
                                    ...
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Summer Essentials</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                            ...
                            <div class="collections-slide">
                                <div class="collections-banner-item">
                                    ...
                                    <div class="collections-banner-content py-4">
                                        <h5 class="collections-element-title text-uppercase">
                                            <a href="index.html" class="collections-item-anchor">Autumn Styles</a>
                                        </h5>
                                        <p>Scelerisque duis aliquam qui lorem ipsum dolor amet, consectetur adipiscing elit.</p>
                                        <div class="btn-left">
                                            <a href="#" class="collections-btn-link fs-6 text-uppercase">Discover Now</a>
                        ...
                        <!-- Navigation Arrows -->
                        <div class="collections-nav-arrow collections-prev" id="collectionsPrev">
                            <svg viewBox="0 0 24 24">
                                <path d="M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z"/>
                            </svg>
                        </div>
                        <div class="collections-nav-arrow collections-next" id="collectionsNext">
                            <svg viewBox="0 0 24 24">
