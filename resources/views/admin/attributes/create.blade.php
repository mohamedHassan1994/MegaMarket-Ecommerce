...
@section('admin_page_title', 'Create Attribute')
    ...
    <div class="col-12">
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                {{-- Attribute Form --}}
                <form id="attributeForm" action="{{ route('attributes.store') }}" method="POST">
                    @csrf
                    ...
                    {{-- Attribute Values (for select, radio, checkbox) --}}
                    ...
                    <button type="submit" id="submitBtn" class="btn btn-success w-100">Add Attribute</button>
                </form>
