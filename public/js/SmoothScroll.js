...
class CollectionsSlider {
    constructor() {
        this.currentSlide = 0;
        this.totalSlides = 6;
        this.wrapper = document.getElementById('collectionsWrapper');
        this.prevBtn = document.getElementById('collectionsPrev');
        this.nextBtn = document.getElementById('collectionsNext');
        this.pagination = document.getElementById('collectionsPagination');
        this.slides = document.querySelectorAll('.collections-slide');
    ...
    updateSlider() {
        ...
        // Update active slide class (optional)
...
document.addEventListener('DOMContentLoaded', () => {
    new CollectionsSlider();
});

// Handle keyboard navigation
document.addEventListener('keydown', (e) => {
    if (e.key === 'ArrowLeft') {
        document.getElementById('collectionsPrev').click();
    } else if (e.key === 'ArrowRight') {
        document.getElementById('collectionsNext').click();
    }
});